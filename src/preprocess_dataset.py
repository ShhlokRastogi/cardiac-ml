...
try:
    ...
    HAS_NIBABEL = False
from src.config import RAW_TRAIN_DB_DIR, RAW_TEST_DB_DIR, PREPROCESSED_DIR
...
def preprocess_slice_exact(image_slice, mask_slice=None, current_spacing=(1.5, 1.5), target_spacing=(1.25, 1.25), target_shape=(216, 256)):
